...
async function Printer_WebScraping(PrinterHostname,con){
    ...
    await (async () => {
        ...
        try{ 
            ...
            try{
                ...
                console.log("Top Bar - "+PrinterHostname+" failed");
            }
                    ...
                    switch(PrinterTopBar.Printer_Model){
                        case "Lexmark X864de":
                            ...
                            break;
                                ...
                                console.log("Lexmark X864de web scraping failed");
                            }
                        case "Lexmark XM9155":
                            try{
                            ...
                            console.log("Lexmark XM9155 web scraping failed");
                        }
                        case "Lexmark XM7155":
                            try{
                                Printer_Tray1_Name = document.querySelector('.status_table:nth-of-type(3) tr:nth-of-type(3) td' ).innerText;
                                ...
                                console.log("Lexmark XM7155 web scraping failed");
                            }       
                    }
                    return {
            ...
            console.log("Bot Bar - "+PrinterHostname+" failed");
        }
                ...
                if (timeleft == -1) {
                    (async ()=>{
                        for(var i = 0; i<PrinterArray.length; i++){
                            await Printer_WebScraping(PrinterArray[i],con);
                            console.log("-------------------------");
                        }
                    })();
