...
function webScraping(Printer_Hostname){
    const puppeteer = require('puppeteer');
    
    var PrintHostname = Printer_Hostname;
    (async ()=> {

        let printerURL = "http://"+PrintHostname+".internal/cgi-bin/dynamic/topbar.html";
    ...
    (async ()=> {
        ...
        let printerURL = "http://"+PrintHostname+".internal/cgi-bin/dynamic/printer/PrinterStatus.html";
        let browser = await puppeteer.launch();
        let page = await browser.newPage();
